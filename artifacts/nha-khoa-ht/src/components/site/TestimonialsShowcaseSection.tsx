    ...
    <section id="feedback" className="relative overflow-hidden bg-[linear-gradient(180deg,#f8fbff_0%,#fff_35%,#f6f9ff_100%)] py-20">
      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-3 max-w-3xl text-base leading-7 text-white/82">
          ...
          {SERVICE_TABS.map((tab, index) => (
            <button
              ...
              className={`rounded-full px-7 py-3 text-lg font-semibold transition ${
                index === 0
                  ? "border border-white/20 bg-white/12 text-white shadow-[0_12px_28px_rgba(24,44,100,.10)]"
        ...
        <div className="relative mt-10">
          <button
            ...
            className="absolute left-0 top-1/2 z-10 hidden h-14 w-14 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full border border-white/20 bg-white/12 text-white shadow-[0_12px_28px_rgba(24,44,100,.12)] lg:grid"
          >
          ...
          <button
            ...
            className="absolute right-0 top-1/2 z-10 hidden h-14 w-14 translate-x-1/2 -translate-y-1/2 place-items-center rounded-full border border-white/20 bg-white/12 text-white shadow-[0_12px_28px_rgba(24,44,100,.12)] lg:grid"
          >
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            {items.map((item) => (
              <article
                key={item.id}
                className="overflow-hidden rounded-[2rem] border border-white/16 bg-white/10 shadow-[0_22px_54px_rgba(16,37,89,.10)] transition duration-300 hover:-translate-y-1.5 hover:shadow-[0_28px_64px_rgba(16,37,89,.16)]"
              >
                ...
                <div className="bg-[linear-gradient(180deg,hsl(233,48%,42%),hsl(233,48%,37%))] p-7 text-white">
                  ...
                  <div className="mt-4 flex items-end justify-between gap-4 border-b border-white/18 pb-4">
                    <div>
                      <h3 className="text-[1.85rem] font-bold leading-none text-white">{item.name}</h3>
