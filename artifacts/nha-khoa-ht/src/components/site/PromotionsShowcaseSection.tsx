    ...
    <section className="relative overflow-hidden bg-[linear-gradient(180deg,#f7fbff_0%,#ffffff_55%,#f8fbff_100%)] py-20">
      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="flex flex-wrap items-end justify-between gap-6">
          ...
          <Link
            href="/khuyen-mai"
            className="inline-flex items-center gap-2 rounded-full border border-[hsl(223,68%,24%)] bg-white/85 px-6 py-3 text-sm font-semibold text-[hsl(223,68%,24%)] shadow-[0_12px_28px_rgba(15,39,103,.08)] backdrop-blur transition hover:-translate-y-0.5 hover:bg-[hsl(223,68%,24%)] hover:text-white"
          >
            Xem toàn bộ
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[1.28fr_.86fr_.86fr]">
          {items.slice(0, 3).map((promo, index) => (
            <article
              key={promo.id}
              className="group overflow-hidden rounded-[2.1rem] border border-white bg-white/92 shadow-[0_22px_52px_rgba(16,37,89,.09)] transition duration-300 hover:-translate-y-1.5 hover:shadow-[0_28px_62px_rgba(16,37,89,.14)]"
            >
              ...
              <div className="space-y-4 p-6">
                <p className="text-[0.98rem] leading-7 text-slate-600">{promo.content}</p>
                <a
                  href="/lien-he#booking"
                  className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50/85 px-4 py-2.5 text-sm font-semibold text-[hsl(223,68%,24%)] transition hover:border-[hsl(223,68%,39%)] hover:bg-white hover:text-[hsl(223,68%,39%)]"
                >
                  Đăng ký ngay
                  <ArrowRight className="h-4 w-4" />
                </a>
